...
// //Case 1-Same Time Same Space Array (all 8b)
// class STSSMultiplierArrayIO(val Units:Int, val Prec1:Int, val Prec2:Int) extends Bundle {
// 	val data1 = Input(Vec(Units, UInt(Prec1.W) ))
// 	val data2 = Input(Vec(Units, UInt(Prec2.W) ))
// 	val res = Output(Vec(Units,  UInt((Prec1+Prec2).W)))
// }

// class STSSMultiplierArray(val Units:Int, val Prec1:Int, val Prec2:Int) extends Module {
// 	val io = IO(new Bundle{
// 		val data = STSSMultiplierArrayIO(Prec1, Prec2)
// 		val out = Decoupled(Bool())
// 		val in = Flipped(Decoupled(Bool()))
// 	})
// }

// //Case 2 - Different Time Same Space Array (i.e. multiprecision dataflows, bitfusion. L1-4b, L2-8b)

// //Case 3 - Same Time Different Space Array (i.e. hetereogenous PE array, i.e. alu-like, SuperPEs)

// //Case 4 - Different Time Different Space Array (i.e. )
