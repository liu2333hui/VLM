module FixedPointTrigExp_D22_approx_op_PipelineUInt(
  input         clock,
  input         reset,
  output        io_in_ready,
  input         io_in_valid,
...
module FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder(
  input  [4:0]  io_in,
  input  [31:0] io_x,
  output [31:0] io_out
);
...
module FixedPointTrigExp_D22_approx_op_BoothMultiplier(
  input         clock,
  input         reset,
  output        io_out_valid,
  input         io_out_ready,
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_3;
`endif // RANDOMIZE_REG_INIT
  wire [4:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_in; // @[shiftmultiplier.scala 228:32]
  wire [31:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_x; // @[shiftmultiplier.scala 228:32]
  wire [31:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_out; // @[shiftmultiplier.scala 228:32]
  ...
  wire [31:0] _T_38 = $signed(_T_14) + $signed(FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_out); // @[shiftmultiplier.scala 291:36]
  ...
  FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder ( // @[shiftmultiplier.scala 228:32]
    .io_in(FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_in),
    .io_x(FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_x),
    .io_out(FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_out)
  );
  ...
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_in = _T_21 ? _T_18[4:0] : _GEN_19; // @[shiftmultiplier.scala 260:27 shiftmultiplier.scala 265:35 shiftmultiplier.scala 272:43 shiftmultiplier.scala 288:35]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_x = _T_21 ? $signed({{16{io_math_data2[15]}},io_math_data2}) : $signed(_GEN_20); // @[shiftmultiplier.scala 261:25 shiftmultiplier.scala 266:33 shiftmultiplier.scala 273:41 shiftmultiplier.scala 289:33]
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
`endif
`ifdef RANDOMIZE_INVALID_ASSIGN
...
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    _T_13 <= _GEN_23[31:0];
    if (_T_21) begin
      _T_14 <= FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_out;
    end else if (_T_3) begin
      if (_T_27) begin
        _T_14 <= FixedPointTrigExp_D22_approx_op_BoothMultiplier_BoothEncoder_io_out;
      end
...
module FixedPointTrigExp_D22_approx_op(
  input        clock,
  input        reset,
  input  [7:0] io_data_i,
  input  [7:0] io_data_f,
  ...
  wire  FixedPointTrigExp_D22_approx_op_PipelineUInt_clock; // @[UnaryOp.scala 121:57]
  wire  FixedPointTrigExp_D22_approx_op_PipelineUInt_reset; // @[UnaryOp.scala 121:57]
  wire  FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_ready; // @[UnaryOp.scala 121:57]
  wire  FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_valid; // @[UnaryOp.scala 121:57]
  wire [15:0] FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_bits; // @[UnaryOp.scala 121:57]
  wire  FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_ready; // @[UnaryOp.scala 121:57]
  wire  FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_valid; // @[UnaryOp.scala 121:57]
  wire [15:0] FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_bits; // @[UnaryOp.scala 121:57]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_clock; // @[UnaryOp.scala 137:55]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_reset; // @[UnaryOp.scala 137:55]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_valid; // @[UnaryOp.scala 137:55]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_ready; // @[UnaryOp.scala 137:55]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_valid; // @[UnaryOp.scala 137:55]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_ready; // @[UnaryOp.scala 137:55]
  wire [15:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_data1; // @[UnaryOp.scala 137:55]
  wire [15:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_data2; // @[UnaryOp.scala 137:55]
  wire [31:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_res; // @[UnaryOp.scala 137:55]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_clock; // @[UnaryOp.scala 140:56]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_reset; // @[UnaryOp.scala 140:56]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_out_valid; // @[UnaryOp.scala 140:56]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_out_ready; // @[UnaryOp.scala 140:56]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_in_valid; // @[UnaryOp.scala 140:56]
  wire  FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_in_ready; // @[UnaryOp.scala 140:56]
  wire [15:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_data1; // @[UnaryOp.scala 140:56]
  wire [15:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_data2; // @[UnaryOp.scala 140:56]
  wire [31:0] FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_res; // @[UnaryOp.scala 140:56]
  wire [31:0] _T_9 = $signed(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_res) + 32'sh10000; // @[UnaryOp.scala 160:63]
  wire [31:0] _T_21 = $signed(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_res) + 32'sh10000; // @[UnaryOp.scala 172:64]
  FixedPointTrigExp_D22_approx_op_PipelineUInt FixedPointTrigExp_D22_approx_op_PipelineUInt ( // @[UnaryOp.scala 121:57]
    .clock(FixedPointTrigExp_D22_approx_op_PipelineUInt_clock),
    .reset(FixedPointTrigExp_D22_approx_op_PipelineUInt_reset),
    .io_in_ready(FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_ready),
    .io_in_valid(FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_valid),
    .io_in_bits(FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_bits),
    .io_out_ready(FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_ready),
    .io_out_valid(FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_valid),
    .io_out_bits(FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_bits)
  );
  FixedPointTrigExp_D22_approx_op_BoothMultiplier FixedPointTrigExp_D22_approx_op_BoothMultiplier ( // @[UnaryOp.scala 137:55]
    .clock(FixedPointTrigExp_D22_approx_op_BoothMultiplier_clock),
    .reset(FixedPointTrigExp_D22_approx_op_BoothMultiplier_reset),
    .io_out_valid(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_valid),
    .io_out_ready(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_ready),
    .io_in_valid(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_valid),
    .io_in_ready(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_ready),
    .io_math_data1(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_data1),
    .io_math_data2(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_data2),
    .io_math_res(FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_res)
  );
  FixedPointTrigExp_D22_approx_op_BoothMultiplier FixedPointTrigExp_D22_approx_op_BoothMultiplier_1 ( // @[UnaryOp.scala 140:56]
    .clock(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_clock),
    .reset(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_reset),
    .io_out_valid(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_out_valid),
    .io_out_ready(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_out_ready),
    .io_in_valid(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_in_valid),
    .io_in_ready(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_in_ready),
    .io_math_data1(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_data1),
    .io_math_data2(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_data2),
    .io_math_res(FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_res)
  );
  assign io_res_i = _T_21[23:16]; // @[UnaryOp.scala 179:42]
  assign io_res_f = _T_21[15:8]; // @[UnaryOp.scala 180:42]
  assign io_out_valid = FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_out_valid; // @[UnaryOp.scala 178:46]
  assign io_in_ready = FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_ready; // @[UnaryOp.scala 177:45]
  assign FixedPointTrigExp_D22_approx_op_PipelineUInt_clock = clock;
  assign FixedPointTrigExp_D22_approx_op_PipelineUInt_reset = reset;
  assign FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_valid = FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_valid; // @[UnaryOp.scala 150:57]
  assign FixedPointTrigExp_D22_approx_op_PipelineUInt_io_in_bits = {io_data_i,io_data_f}; // @[UnaryOp.scala 148:56]
  assign FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_ready = FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_ready; // @[UnaryOp.scala 149:58]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_clock = clock;
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_reset = reset;
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_ready = FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_in_ready; // @[UnaryOp.scala 155:56]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_in_valid = io_in_valid; // @[UnaryOp.scala 156:55]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_data1 = {io_data_i,io_data_f}; // @[UnaryOp.scala 153:57]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_math_data2 = 16'sh80; // @[UnaryOp.scala 154:57]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_clock = clock;
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_reset = reset;
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_out_ready = io_out_ready; // @[UnaryOp.scala 167:57]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_in_valid = FixedPointTrigExp_D22_approx_op_BoothMultiplier_io_out_valid; // @[UnaryOp.scala 168:56]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_data1 = {_T_9[23:16],_T_9[15:8]}; // @[UnaryOp.scala 165:58]
  assign FixedPointTrigExp_D22_approx_op_BoothMultiplier_1_io_math_data2 = FixedPointTrigExp_D22_approx_op_PipelineUInt_io_out_bits; // @[UnaryOp.scala 166:58]
endmodule
module FixedPointTrigExp_D22(
  input        clock,
  input        reset,
  input  [7:0] io_in0_i,
  input  [7:0] io_in0_f,
  ...
  FixedPointTrigExp_D22_approx_op main ( // @[TrigFixedPoint.scala 45:26]
    .clock(main_clock),
    .reset(main_reset),
